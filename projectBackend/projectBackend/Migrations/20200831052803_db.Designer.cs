...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("projectBackend.Models.Reservation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("RentRideStart")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("RideRentDays")
                        .HasColumnType("int");

                    b.Property<int>("StatusFlight")
                        .HasColumnType("int");

                    b.Property<int>("StatusRide")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("projectBackend.Models.RideCompany", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RideCompanies");
                });

            modelBuilder.Entity("projectBackend.Models.Seat", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("projectBackend.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("projectBackend.Models.Ride", "Ride")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("projectBackend.Models.Ride", b =>
                {
                    b.HasOne("projectBackend.Models.RideCompany", "Company")
                        .WithMany("Rides")
                        .HasForeignKey("CompanyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("projectBackend.Models.Seat", b =>
                {
                    ...
                    b.HasOne("projectBackend.Models.Reservation", "Reservation")
                        .WithMany("Seats")
